    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 md:pt-30 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          <h1 className="text-[26px] md:text-[36px] lg:text-[44px] font-semibold text-gray-800">
          ...
          <p className="text-sm">
            Courese by{" "}
            <span className="text-blue-600 underline">Vani Singh</span>
          </p>
        ...
        <div className="max-w-[424px] z-10 shadow-[0px_4px_15px_2px_rgba(0,0,0,0.1)] rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5">
            ...
            <div className="flex gap-3 items-center pt-2">
              <p className="text-gray-800 md:text-2xl text-lg font-semibold">{currency}{(courseData.coursePrice- courseData.discount*courseData.coursePrice/100).toFixed(2)}</p>
              <p className="md:text-lg text-sm text-gray-500 line-through">{currency}{courseData.coursePrice}</p>
